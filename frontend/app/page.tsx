...
// ─── Main page ────────────────────────────────────────────────────────────────
export default function GitRapLandingPage() {
    ...
    <div className="bg-[#F5F4F0] text-[#111] min-h-screen font-sans antialiased">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 z-30 flex flex-col px-6 md:px-12 pb-12 max-w-3xl">
          ...
          >
            Turn your<br />GitHub into<br />on-chain<br />reputation.
          </h1>

          {/* 3 metrics — staggered after title */}
          <div className="flex gap-8 sm:gap-12">
            {[
              { value: "10k+", label: "Verified Devs" },
              { value: "100%", label: "Verifiable" },
              { value: "180+", label: "DAOs" },
            ].map((stat, i) => (
              <div
                key={i}
                style={{
          ...
          <div className="grid grid-cols-12 grid-rows-auto gap-3" onMouseMove={handleMouse}>
            ...
            <BentoCard className="col-span-12 p-8 min-h-[200px] flex flex-col justify-between relative overflow-hidden" delay={0}>
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-light mb-3">Connect Wallet & GitHub</h3>
                <p className="text-sm text-black/45 leading-relaxed max-w-sm">
                  Securely link your identity to generate verifiable on-chain reputation metrics based on your actual contributions.
                </p>
              </div>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={120}>
              ...
              <h3 className="text-lg font-light mb-2">Transparent Scoring</h3>
              <p className="text-sm text-black/45 leading-relaxed">View exactly how your open source impact, commits, and PRs translate to reputation.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={160}>
              ...
              <h3 className="text-lg font-light mb-2">Soulbound Tokens</h3>
              <p className="text-sm text-black/45 leading-relaxed">Mint your non-transferable SBT representing your developer ranking and achievements.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={200}>
              ...
              <h3 className="text-lg font-light mb-2">DAO Discovery</h3>
              <p className="text-sm text-black/45 leading-relaxed">Get discovered by top Web3 teams seeking proven, verifiable builder talent.</p>
            </BentoCard>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              ...
              <div className="mt-4"><Tag>VERIFIED DEVS</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
                {"Top Web3 Talent\nready to hire."}
              </RevealText>
            </div>
            <p className="text-sm text-black/45 leading-relaxed max-w-xs">
              Find developers based on their verified on-chain score. No resumes, just verifiable code contributions.
            </p>
          </div>
      ...
      <section id="workflow" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3" onMouseMove={handleMouse}>
            {[
              { n: "01", title: "Connect",  desc: "Link your Web3 wallet and authorize GitHub in one click.", delay: 0,   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/define-5aafAmGBrxZpOqJ3XLHY3n3qzC2I5K.png" },
              { n: "02", title: "Analyze", desc: "GitRap's indexer evaluates your commits, PRs, issues and stars.", delay: 80,  img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/compose-5RT5VR4f1Y3GoFmovqTKLTG4UXp3g2.png" },
              { n: "03", title: "Score",    desc: "Receive your transparent, verifiable reputation score.", delay: 140, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/test-zm8guZwxJHtwWsJ7XO4B0CF7GzlNK8.png" },
              { n: "04", title: "Mint",  desc: "Mint your Soulbound Token (SBT) and unlock DAO bounties.", delay: 200, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/deploy-an8fgHSLzniojkcmRyGGIFQUJF9T5J.png" },
            ].map((step) => (
      ...
      <section className="py-0 border-t border-black/[0.06] overflow-hidden select-none">
        <div className="flex border-b border-black/[0.06]" style={{ animation: "marqueeLeft 28s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["React", "Solidity", "Rust", "Go", "Smart Contracts", "DeFi", "ZK Proofs", "EVM", "Cryptography", "Subgraphs"].map((cap) => (
        ...
        <div className="flex" style={{ animation: "marqueeRight 22s linear infinite" }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Open Source", "Hackathons", "Bounties", "Grants", "Core Contributor", "Audits", "Full Stack", "Frontend", "Backend", "Security"].map((cap) => (
                <div key={cap} className="flex items-center gap-6 px-10 py-5 border-r border-black/[0.06] shrink-0">
      ...
      <section className="relative py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.05] mb-6">
            Start building your<br />on-chain reputation.
          </h2>
          <p className="text-sm text-black/45 leading-relaxed mb-10">
            Join thousands of developers turning their GitHub activity into verifiable Web3 credentials.
          </p>
          {!submitted ? (
            <form
      ...
      <footer className="py-10 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <span className="font-pixel text-xs tracking-[0.25em] text-black/50">GITRAP</span>
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-black/[0.04]">
          <span className="text-xs text-black/20">© 2026 GITRAP. All rights reserved.</span>
        </div>
      </footer>
    </div>
  )
